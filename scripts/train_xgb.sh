...
/home/haicu/lisa.barros/anaconda3/envs/rogue_wave/bin/python -u train_model.py --model_type xgb --file_data ../data/data_train_test.pickle --dir_output ../results/xgb/ --n_jobs 50