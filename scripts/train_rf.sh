...
/home/haicu/lisa.barros/anaconda3/envs/rogue_wave/bin/python -u train_model.py --model_type rf --file_data ../data/data_train_test.pickle --dir_output ../results/rf/ --n_jobs 50